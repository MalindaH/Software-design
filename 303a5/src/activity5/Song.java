...
/**
 * Represents a piece of audio media that can be played, along with its metadata.
 */
public class Song extends AbstractPlayable
{
	 ...
	 * 
	 * @param pTitle
	 *          The title. Can be empty but not null.
	 * @pre pTitle != null
	 */
	...
	/**
	 * Set a piece of meta-data to associate with this song. Tags are case-insensitive.
	 * 
	 * @param pTag
	 *          The tag for the piece of meta data.
	 * @param pValue
	 *          The value for the piece of meta-data.
	 ...
	 * @param pTag
	 *          The tag to get.
	 * @return The value for the tag, or a string indicating that there is no value for this tag if that's the case.
	 * @pre pTag != null;
	 */
	...
	/**
	 * overriding equals for comparing two songs
	 */
	@Override
	public boolean equals(Object pSong)
	{
		...
		try
		{
			return this.aFile.getCanonicalPath().equals(other.aFile.getCanonicalPath());
		}
		catch (IOException e)
		{
			return false;
	...
	/**
	 * hashcode of the song object :: overridden
	 */
	@Override
	public int hashCode()
	{
